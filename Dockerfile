...
ARG NEXT_PUBLIC_ENABLE_BETA_FEEDBACK
ARG NEXT_PUBLIC_BETA_FEEDBACK_TEST_MODE
ENV API_BASE_URL=${API_BASE_URL} \
    ...
    NEXT_PUBLIC_ENABLE_BETA_FEEDBACK=${NEXT_PUBLIC_ENABLE_BETA_FEEDBACK} \
    NEXT_PUBLIC_BETA_FEEDBACK_TEST_MODE=${NEXT_PUBLIC_BETA_FEEDBACK_TEST_MODE}
